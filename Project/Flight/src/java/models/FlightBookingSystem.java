...
public class FlightBookingSystem
{
    public ArrayList<Features> populateFeatures(Connection con)
    {
        ...
        try
        {
            ...
            Logger.getLogger(FlightBookingSystem.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static int getPrice(String origin, String destination)
    {
        ...
        try
        {
            p = new File(FlightBookingSystem.class.getProtectionDomain().getCodeSource().getLocation().toURI()).getPath() + "\\airlines.accdb";
        }
